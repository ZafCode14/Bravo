    ...
    <section className="flex flex-col items-center">
      <div className="relative h-[380px] w-full md:h-[600px] lg:h-[1100px]">
        <Image 
          ...
          src={'/images/graphicalElGreen.svg'} 
          height={"2000"} 
          width={"1000"} 
          className={width >= 768 ? "md:absolute md:top-[0] md:left-0 md:h-auto md:w-[600px] lg:w-[1200px]" : "hidden"}/>
        <Image 
          alt="textbook image" 
      ...
      <div className="relative w-full h-[380px] md:h-[600px] overflow-hidden lg:h-[1150px]">
        <Image 
          ...
          height={"2000"} 
          width={"1000"} 
          className={width >= 768 ? "md:absolute md:top-[0] md:right-[-100px] md:h-auto md:w-[600px] lg:w-[1200px] lg:right-[-250px]" : "hidden"}
        />
        <Image 
          alt="textbook image" 
          src={'/images/textbook.jpg'} 
          height={"2000"} 
          width={"1000"} 
          className="absolute top-0 left-0 w-[285px] h-auto md:w-[500px] lg:w-[920px]"
        />
        <Image 
          alt="phone image" 
