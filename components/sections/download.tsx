...
function Download() {
  ...
  return (
    <section className="bg-color-black w-full flex flex-col items-center justify-center sm:px-8 md:px-3 relative overflow-hidden md:pt-20 md:pb-40">
      ...
      <p className="md:text-[26px] text-white mt-11 mb-2 relative">Download our app now!</p>
      <p className="md:text-[24px] text-white mb-11 relative">It’s free!</p>
